...
# 4. Final Model: Stacking (XGBoost + LightGBM + CatBoost)
...
# Base Models
# Note: tree_method='gpu_hist' uses GPU for XGBoost
xgb_model = xgb.XGBRegressor(n_estimators=1000, learning_rate=0.02, max_depth=10, subsample=0.8, tree_method='hist', random_state=42)
lgb_model = lgb.LGBMRegressor(n_estimators=1000, learning_rate=0.02, num_leaves=64, random_state=42)
cat_model = CatBoostRegressor(iterations=1000, learning_rate=0.02, depth=10, silent=True, random_state=42)
...
print("\nSuper Model saved to super_stacking_model.pkl")
